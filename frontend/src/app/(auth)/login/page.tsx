          ...
          <Card className="relative border-border/50 bg-card/60 backdrop-blur-xl shadow-2xl glow-card">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 text-base font-semibold transition-all shadow-lg hover:shadow-primary/25 bg-primary hover:bg-primary/90 mt-2 flex items-center justify-center group"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
            ...
            <CardFooter className="flex flex-col border-t border-border/30 pt-6 pb-8">
              <p className="text-center text-sm text-muted-foreground">
                ...
                <Link href="/register" className="font-semibold text-primary hover:underline hover:text-primary transition-all">
                  Sign up
                </Link>
              </p>
            </CardFooter>
